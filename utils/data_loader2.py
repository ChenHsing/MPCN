...
BASE_NAME = ['aeroplane','car','chair','display','speaker','table','telephone']
USE_AVERAGE = True
...
class PascalDataset(torch.utils.data.dataset.Dataset):
    ...
    def get_datum(self, idx):
        ...
        rendering_images = []
        for image_path in selected_rendering_image_paths:
            rendering_image = cv2.imread(image_path).astype(np.float32) / 255.
...
# //////////////////////////////// = End of PascalDataset Class Definition = ///////////////////////////////// #
    ...
    def get_files_of_taxonomy(self, dataset_type, taxonomy_folder_name):
        ...
        with open(taxonomy_folder_name, "r") as f:
            for line in f.readlines():
                ...
                prior_path = os.path.join(self.volume_path_template, clz.split('_')[0], '01.npy')
